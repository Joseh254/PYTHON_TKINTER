...
button__add = Button(root, text="+", pady=20, padx=40, command=button_add, bg="green", fg="white")
button_exit = Button(root, text="Exit", pady=20, padx=40, command=root.quit, bg="red", fg="white")
button__equal = Button(root, text="=", pady=20, padx=40, command=button_equal, bg="blue", fg="white")
button_edel = Button(root, text="del", pady=20, padx=40, command=button_del, fg="white", bg="black", width=2, height=1)
...
button__add.grid(row=4, column=1)
button__equal.grid(row=5, column=2)

button_subtract.grid(row=4, column=2)
button_multiplication.grid(row=5, column=0)
button_division.grid(row=5, column=1)
button_edel.grid(row=6, column=0)
